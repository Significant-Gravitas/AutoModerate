...
class Project(db.Model):
    ...
    # Relationships
    api_keys = db.relationship('APIKey', backref='project', lazy=True, cascade='all, delete-orphan')
    content = db.relationship('Content', backref='project', lazy=True, cascade='all, delete-orphan')
    moderation_rules = db.relationship('ModerationRule', backref='project', lazy=True, cascade='all, delete-orphan')
